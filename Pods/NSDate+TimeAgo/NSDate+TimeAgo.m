...
- (NSString *)change2Ch:(int)num
{
    NSString *ten;
    NSString *one;
    
    NSArray * arrayChNum = [NSArray arrayWithObjects:@"一",@"二",@"三", @"四",@"五",@"六",@"七",@"八",@"九",nil];
    ...
    {
        ten = arrayChNum[i - 1];
        ten = [NSString stringWithFormat:@"%@十", ten];
    }
    ...
    else
    {
        ...
        {
            one = arrayChNum[j - 1];
            one = [NSString stringWithFormat:@"%@", one];
        }
    }
    
    return [NSString stringWithFormat:@"%@%@", ten, one];
}
...
- (NSString *)timeAgo
{
    ...
    {
        return [NSString stringWithFormat:@"%@秒前",[self change2Ch:deltaSeconds]];
    }
    else if(deltaSeconds < 120)
    {
        return NSDateTimeAgoLocalizedStrings(@"一分钟前");
    }
    else if (deltaMinutes < 60)
    {
        return [NSString stringWithFormat:@"%@分钟前",[self change2Ch:deltaMinutes]];
//        return [self stringFromFormat:@"%%d%@分钟前" withValue:deltaMinutes];
    }
    else if (deltaMinutes < 120)
    {
        return NSDateTimeAgoLocalizedStrings(@"一个小时前");
    }
    else if (deltaMinutes < (24 * 60))
    {
        minutes = (int)floor(deltaMinutes/60);
        return [NSString stringWithFormat:@"%@个小时前",[self change2Ch:minutes]];
//        return [self stringFromFormat:@"%%d%@个小时前" withValue:minutes];
    }
    ...
    else if (deltaMinutes < (24 * 60 * 7))
    {
        ...
        return [NSString stringWithFormat:@"%@天前",[self change2Ch:minutes]];
//        return [self stringFromFormat:@"%%d%@天前" withValue:minutes];
    ...
    else if (deltaMinutes < (24 * 60 * 31))
    {
        ...
        return [NSString stringWithFormat:@"%@周前",[self change2Ch:minutes]];
//        return [self stringFromFormat:@"%%d%@周前" withValue:minutes];
    }
    else if (deltaMinutes < (24 * 60 * 61))
    {
        return NSDateTimeAgoLocalizedStrings(@"上个月");
    }
    else if (deltaMinutes < (24 * 60 * 365.25))
    {
        minutes = (int)floor(deltaMinutes/(60 * 24 * 30));
        return [NSString stringWithFormat:@"%@个月前",[self change2Ch:minutes]];
//        return [self stringFromFormat:@"%%d%@个月前" withValue:minutes];
    }
    ...
    return [NSString stringWithFormat:@"%@年前",[self change2Ch:minutes]];
